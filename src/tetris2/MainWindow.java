...
public class MainWindow {
		...
		EventQueue.invokeLater(new Runnable() { //parameterkent at van adva egy nevtelen osztaly
			public void run() {
				try {
					...
					// A j�t�k logik�ja egy k�l�n sz�lon fusson:
	...
	private void initialize() {
		...
		gameArea.setHighlighter(null); // ut�lag gener�lva: a sz�vegen ne lehessen kijel�lni
		gameArea.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent keyEvent) {
				...
				break;
				case KeyEvent.VK_DOWN: tetrisGame.dropBlock(); // lefele nyillal gyors�tjuk (a sleep()-en kereszt�l)
				break;
				case KeyEvent.VK_SPACE: tetrisGame.rotate(); // lefele nyillal gyors�tjuk (a sleep()-en kereszt�l)
				break;
				default:
					break;
				}
